...
class UserProfile(models.Model):
    ...
    first_name = models.CharField(
        _("first name"), max_length=150, blank=True, null=True, editable=True
    )
    ...
    saving_profile = models.TextField(blank=True, editable=True)
    country = models.CharField(max_length=50, blank=True, editable=True)
